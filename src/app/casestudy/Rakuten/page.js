                    ...
                    <div className={`rounded-4xl bg-zinc-50 p-8 md:p-12 dark:bg-slate-900 ${PROSE}`}>
                        ...
                        <div className="relative h-[55vh] overflow-hidden rounded-2xl mb-8 bg-[url('/offerBG.png')] bg-cover">
                            <div className="flex h-full items-center justify-center">
                                <Image sizes="(max-width: 768px) 100vw, 1008px" priority className="rounded-2xl ring-1 ring-black/10 dark:ring-white/10" src="/offersFull.png" width={1000} height={640} alt="Redesigned Rakuten Advertising offer management dashboard showing the full offer invitation and comparison interface" />
                            </div>
                        </div>
