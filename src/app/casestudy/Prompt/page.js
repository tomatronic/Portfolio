                    ...
                    <div className={`rounded-4xl bg-zinc-50 p-8 md:p-12 dark:bg-slate-900 ${PROSE}`}>
                        ...
                        <div className="grid auto-rows-auto grid-cols-1 gap-5 md:grid-cols-4 md:gap-10">
                            ...
                            <div className="col-span-4 mb-12">
                                ...
                                <p>The existing report builder started empty and stayed that way until you told it what to measure. Picking columns meant working through more than a dozen collapsed categories in a side panel — Metrics, Clicks, Commission, Geography and the rest — where some combinations quietly aren&apos;t permitted, and nothing rendered at all until at least one metric was chosen. Fifteen to twenty minutes later you had a table. And if the question you started with needed a number the table didn&apos;t directly answer, you exported it and worked it out in Excel.</p>
